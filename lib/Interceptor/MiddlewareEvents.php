...
namespace FicoScoreInsuranceSimulacion\Client\Interceptor;
...
use \FicoScoreInsuranceSimulacion\Client\Interceptor\KeyHandler;
use \FicoScoreInsuranceSimulacion\Client\Interceptor\MyLogger;
use \FicoScoreInsuranceSimulacion\Client\Model\Errors;
use \FicoScoreInsuranceSimulacion\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\FicoScoreInsuranceSimulacion\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \FicoScoreInsuranceSimulacion\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \FicoScoreInsuranceSimulacion\Client\Model\Errores(["errors" => [$error]]);
